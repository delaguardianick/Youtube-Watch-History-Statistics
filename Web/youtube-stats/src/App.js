...
function App() {
  ...
  const getAllPlotsUrl = async () => {
    ...
    // const charts = setChartsData(data["weekly_avg"]);
    // setPlots(charts);
    setPlots(data);
    setLoading(false);
  };
            ...
            <div className="chart-area">
              <Line
                ...
                options={{
                  ...
                  title: {
                    display: true,
                    text: "Average Watch Time by Weekday",
                  },
                }}
              />
            </div>
                            ...
                            <div className="row align-items-center">
                              ...
                              <div className="col">
                                <div className="text-muted">
                                  {!isLoading &&
                                    takeoutStats &&
                                    takeoutStats.watch_time_in_hours && (
                                      <span>
                                        {takeoutStats.watch_time_in_hours}
                                      </span>
                                    )}
                            ...
                            <div className="row align-items-center">
                              ...
                              <div className="col">
                                <div className="text-muted">
                                  {!isLoading &&
                                    takeoutStats &&
                                    takeoutStats.videos_watched && (
                                      <span>{takeoutStats.videos_watched}</span>
                                    )}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row align-items-center">
                              ...
                              <div className="col">
                                <div className="text-muted">
                                  {!isLoading &&
                                    takeoutStats &&
                                    takeoutStats.fav_creator_by_videos && (
                                      <span>
                                        {takeoutStats.fav_creator_by_videos[0]}{" "}
                                        {takeoutStats.fav_creator_by_videos[1]}{" "}
                                      </span>
                                    )}
                                </div>
                              </div>
                            ...
                            <div className="row align-items-center">
                              ...
                              <div className="col">
                                <div className="text-muted">
                                  {!isLoading &&
                                    takeoutStats &&
                                    takeoutStats.most_viewed_month && (
                                      <span>
                                        {takeoutStats.most_viewed_month[0]}{" "}
                                        {takeoutStats.most_viewed_month[1]}{" "}
                                      </span>
                                    )}
                                </div>
                              </div>
                  ...
                  <Col sm={6} className="mb-3">
                    <Card className="plot-image">
                      <Dropdown>
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item
                            onClick={() => setLeftPlot("weekly_avg")}
                          >
                            Weekly
                          </Dropdown.Item>
                          <Dropdown.Item
                            onClick={() => setLeftPlot("hourly_avg")}
                          >
                            Daily
                          </Dropdown.Item>
                          <Dropdown.Item
                            onClick={() => setLeftPlot("monthly_avg")}
                          >
                            Monthly
                          </Dropdown.Item>
                        </Dropdown.Menu>
                  ...
                  <Col sm={6}>
                    <Card className="plot-image">
                      <Dropdown>
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item
                            onClick={() => setRightPlot("top_channels")}
                          >
                            Top Channels
                          </Dropdown.Item>
                          <Dropdown.Item
                            onClick={() => setRightPlot("top_genres")}
                          >
                            Top Genres
                          </Dropdown.Item>
                        </Dropdown.Menu>
